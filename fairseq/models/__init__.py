...
def build_model(cfg: FairseqDataclass, task):
    ...
    # print("eachan print model_type in ?")
    # print( model_type in ARCH_MODEL_REGISTRY)
    # print(model_type in MODEL_DATACLASS_REGISTRY)
    if model_type in ARCH_MODEL_REGISTRY:  # 走这个
    ...
    if model_type in MODEL_DATACLASS_REGISTRY:  # False
        ...
        if model_type in ARCH_CONFIG_REGISTRY:  # True
