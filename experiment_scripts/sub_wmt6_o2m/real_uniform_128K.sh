...
SAVE_DIR=${project_path}/checkpoints/sub_wmt6_o2m/real_uniform_128K
mkdir -vp $SAVE_DIR

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
/userhome/anaconda3/envs/ychuang_online_distillation/bin/python ${project_path}/fairseq_cli/train.py $path_2_data \
  --save-dir $SAVE_DIR \
