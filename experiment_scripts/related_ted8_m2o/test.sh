...
lang_pairs="aze-eng,bel-eng,glg-eng,slk-eng,tur-eng,rus-eng,por-eng,ces-eng"
...
for tgt in eng; do
    for src in aze bel glg slk tur rus por ces; do
...
#
python ${project_path}/experiment_scripts/related_ted8_m2o/result_statistics.py $OUTPUT_DIR > ${OUTPUT_DIR}/result.txt 2>&1