...
SAVE_DIR=${project_path}/checkpoints/sub_wmt6_m2o/LSSD_Whole
mkdir -vp $SAVE_DIR
...
${python_path} ${project_path}/fairseq_cli/train.py $path_2_data \
  ...
  --online-distillation-weight 2.0 > ${SAVE_DIR}/train.log 2>&1

bash ${project_path}/experiment_scripts/sub_wmt6_m2o/test.sh $SAVE_DIR
